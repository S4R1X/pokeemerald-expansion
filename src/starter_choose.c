...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_ARON)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_FLABEBE_RED)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_JANGMO_O )
